<template>
  <div class="container " style="min-height: 597px;">
    ...
    <!-- <div class="block section js-delete block-control-btn"> -->
      <div class="block-item c-red center" v-show="type==='edit'" @click="remove">删除</div>
    <!-- </div> -->
    <div class="block stick-bottom-row center js-save-default">
      <button class="btn btn-standard js-save-default-btn" v-show="type==='edit'" @click="setDefault">设为默认收货地址</button>
    </div>
  </div>
</template>
